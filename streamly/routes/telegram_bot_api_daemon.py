...
async def _download_telegram_bot_api_binary() -> Optional[str]:
    ...
    urls = [
        "https://github.com/aiogram/telegram-bot-api/releases/download/v7.10.0/telegram-bot-api-linux-amd64",
        "https://github.com/aiogram/telegram-bot-api/releases/download/v7.9.0/telegram-bot-api-linux-amd64",
        "https://github.com/aiogram/telegram-bot-api/releases/download/v7.7.0/telegram-bot-api-linux-amd64",
        "https://github.com/tdlib/telegram-bot-api/releases/download/v7.10.0/telegram-bot-api",
        "https://github.com/tdlib/telegram-bot-api/releases/download/v7.9.0/telegram-bot-api",
        "https://github.com/tdlib/telegram-bot-api/releases/download/v7.7.0/telegram-bot-api",
